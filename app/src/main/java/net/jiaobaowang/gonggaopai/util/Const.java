...
public class Const {
  ...
  public static final boolean DEBUG =false; // 是否显示toast
    /****可维护字段*****/
    //开发服务器
//    public static String baseUrl="http://192.168.1.203:8080/banpai/html/index/firstPage.html";    //设置班牌类型成功后跳转的页面路径
//    public static String updateUrl="http://192.168.1.243:8080/app/a.apk";    //App更新路径
