...
public class KeyboardAdapterClasses extends RecyclerView.Adapter<KeyboardAdapterClasses.KeyboardHolder> {

    private Context context;
    private List<String> datas;
    private OnKeyboardClickListener listener;

    public KeyboardAdapterClasses(Context context, List<String> datas) {
    ...
    public KeyboardHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_key_board_classes, parent, false);
    ...
    public void onBindViewHolder(KeyboardHolder holder, int position) {
        if (position == 12) {
            ...
            holder.tvKey.setBackgroundResource(R.color.confirmBtn);
        } else if (position == 10) {
    ...
    class KeyboardHolder extends RecyclerView.ViewHolder {
        ...
        public KeyboardHolder(View itemView) {
            ...
            tvKey = (TextView) itemView.findViewById(R.id.tv_key_classes);
            rlDel = (RelativeLayout) itemView.findViewById(R.id.rl_del_classes);
        }
